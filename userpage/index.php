            ...
            <div class="row main-row">
                ...
                <div class="col table">
                    ...
                    <div class="table-wrapper">
                        ...
                        <?php
                            $sel_prod = mysqli_query($link, "SELECT * FROM `basket` WHERE `iduser`='$id_user' AND `accept`= 0");
                    ...
                    <div class="table-wrapper">
                        ...
                        <?php
                            $sel_prod = mysqli_query($link, "SELECT * FROM `basket` WHERE `iduser`='$id_user' AND `accept`= 1");
                            $sel_prod = mysqli_fetch_all($sel_prod);
