            ...
            <div class="row main-row">
                ...
                <div class="col table">
                    <div class="my-info">
                        ...
                        <?php if($_COOKIE["id_gr"] != 2) { ?>
                            <div class="my-info-wrapper">
                                <div class="adoc-title">
                                    <p>Добавить Контролера</p>
                                </div>
                                <form action="vendor/create-control.php" method="post">
                                    <div class="text-field text-field_floating-2">
                    ...
                    <div class="table-wrapper">
                        ...
                        <?php
                            ...
                            foreach ($sel_prod as $sp) { ?>
                                <div class="tw-main">
                                    <p><?php echo $sp[3]; ?></p>
                                    <img src="<?php print_r("../" . $sp[4] ) ?>" width="150px">
                                    <p><?php echo $sp[2]; ?></p>
                                    <p><?php echo $sp[6]; ?>: <?php echo $sp[5]; ?>руб</p>
                                    <p><?php if($sp[7] == 0) {echo "ОТК еще не пройдено";} else {echo "ОТК Пройден";}; ?></p>
                                    <?php if($_COOKIE["id_gr"] != 1) { 
                                        if($sp[0] == 0) { ?>
                                            <div class="tw-control">
                                                <a href="accept.php?id=<?php echo $sp[0]; ?>" class="twc-btn accept">Пройти ОТК</a>
                                            </div>
                                        <?php } ?>
                                    <?php } ?>
                                </div>
