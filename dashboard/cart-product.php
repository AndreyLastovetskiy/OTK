                ...
                <div class="col table">
                    <div class="my-info">
                        <div class="my-info-wrapper">
                            ...
                            ?>
                            <form action="vendor/update-product.php" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value='<?php echo $selected_prod['id']; ?>'>
                                <div class="text-field text-field_floating-2">
                                    <input class="text-field__input" type="text" id="title" name="title" placeholder="test" value='<?php echo $selected_prod['title']; ?>'>
                                ...
                                <div class="text-field text-field_floating-2">
                                    ...
                                    <img src="<?php print_r("../" . $selected_prod['pathimg']); ?>" width="150px">
                                </div>
                                <div class="text-field text-field_floating-2">
                                    <input class="text-field__input" type="text" id="quantity" name="quantity" placeholder="test" value='<?php echo $selected_prod['quantity']; ?>'>
                                    <label class="text-field__label" for="quantity">Количество</label>
                                </div>
                                <div class="text-field text-field_floating-2">
                                    <input class="text-field__input" type="text" id="price" name="price" placeholder="test" value='<?php echo $selected_prod['price']; ?>'>
